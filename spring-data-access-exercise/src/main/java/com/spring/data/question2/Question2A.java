 ...
 * <p>
 * Question 2:
 * Use DataSource with DriverManagerDataSource to print the records of user table
 */
...
public class Question2A {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("spring-config-question-2A.xml");
